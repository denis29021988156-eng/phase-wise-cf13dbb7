...
Начни с короткого размышления: "У тебя сейчас ${phase.toLowerCase()}, поэтому ты можешь чувствовать себя [описание самочувствия для этой фазы]. В эту фазу лучше есть [рекомендации по питанию для фазы]."

Затем напиши краткий совет (4-6 предложений):
